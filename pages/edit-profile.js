...
class EditProfile extends React.Component {
  ...
  handleSubmit = event => {
    ...
    updateUser(this.state._id, this.userData).then(updatedUser => {
      this.setState({ updatedUser, openSuccess: true });
      setTimeout(() => Router.push(`/profile/${this.state._id}`), 2000);
          ...
          <Paper className={classes.paper}>
            ...
            <form onSubmit={this.handleSubmit} className={classes.form}>
              {isLoading ? (
                  ...
                  <Avatar className={classes.bigAvatar} src={avatarPreview || avatar} />
              )}
              <input
                  type="file"
                  name="avatar"
